...
-- Run this once — lets users upload their own profile picture. A public bucket (avatars need
-- to be visible to everyone, on the leaderboard and elsewhere) where you can only write inside
-- your own user-id folder, mirroring the "Users can update their own profile" pattern above but
-- for storage.objects instead of a table row.
